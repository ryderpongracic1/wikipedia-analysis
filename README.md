...
|----------|-------------|
| **Language** | Python 3.9+ |
| **Graph Database** | Neo4j 4.4+, Cypher, Neo4j Graph Data Science (GDS) |
| **Data Processing** | lxml (iterparse streaming), Pandas |
| **Graph Algorithms** | PageRank, Louvain Community Detection, BFS Shortest Path, Betweenness & Closeness Centrality |
| **REST API** | Flask |
| **Testing** | pytest, pytest-mock, pytest-cov, testcontainers-neo4j |
| **CI/CD** | GitHub Actions (Python 3.9–3.11 matrix, Neo4j service container) |
| **Infrastructure** | Docker, environment-variable-based config |
